package com.ThaoMT8_Assigment_Day.exercise2;
...
public class POIworkbook {
	...
	public static void main(String[] args) {
		final String file="exercise2.xlsx";
		XSSFWorkbook workbook=new XSSFWorkbook();
		XSSFSheet sheet=workbook.createSheet("Exercise 2");
		...
		try {
			...
			workbook.write(out);
			out.close();
			System.out.println("Create file xlsx sucessfull, please click on file exercise2.xlsx to read more");
		}catch(Exception ex) {
			ex.printStackTrace();
		}
	}
