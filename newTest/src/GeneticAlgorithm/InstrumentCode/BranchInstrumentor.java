...
public class BranchInstrumentor extends openjava.mop.OJClass {
	...
	private void openOutputFiles() {
		try {
			...
			pathFile = new java.io.PrintStream(
					new java.io.FileOutputStream(InstrumentorConfiguration.relativePath + className + ".path"));
	...
	public void translateDefinition() throws openjava.mop.MOPException {
		...
		openOutputFiles();
		insertTraceField();
		//System.out.println("Get list of constructors: ");
